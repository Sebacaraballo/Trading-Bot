...
<!-- results:start -->
Backtested on 35 trades across 10 tickers (2024-2026), buying bullish signals with confidence >= 0.6 at the filing-date close and selling 5 trading days later:
...
Latest run: 2026-07-12. Run history: 3 backtests recorded since 2026-05-24, refreshed automatically by the daily data pipeline.
<!-- results:end -->
