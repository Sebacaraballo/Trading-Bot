...
class ExhibitFetcher:
    ...
    def get_exhibit_text(
        ...
        """
        exhibit_url = self._find_exhibit_url(accession_number, cik)
    ...
    def _find_exhibit_url(
        ...
        """
        Fetch the filing index page and return the URL of EX-99.1.
        ...
        Returns:
            Absolute URL to the exhibit document, or ``None`` if not found.
        """
        cik_int = int(cik)
